<div>
    <div class="d-flex align-items-center justify-content-center utama p-4" style="background-color: #5f6df5;">
        ...
        <p class="fw-semibold fs-4 mb-0 ms-4 text-center text-white">Scan Barang Keluar</p>
    </div>
                    ...
                    @if (!empty($barangList))
                        <div class="row g-3 mt-3">
                            ...
                            @foreach ($barangList as $item)
                                ...
                                <input type="number" min="1" class="form-control" wire:model.live="qtyKeluar.{{ $item->id }}" placeholder="Masukkan jumlah keluar">

                                @error("qtyKeluar.$item->id")
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-muted mt-2">
                                <small>* Stok akan dikurangi sesuai jumlah input</small>
                            </p>
                        </div>
                    @else
                        <p class="text-muted">
