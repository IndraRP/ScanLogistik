...
<body class="no-right-click text-dark" style="background-color:aliceblue; font-family: 'Ubuntu', sans-serif;">
    @if (!in_array(Route::currentRouteName(), ["login", "sign_up", "scan", "create", "KeluarIntro", "barang-excel", "ScanMasuk", "ScanKeluar", "BarangMasuk", "CheckBarang", "InputCodeBarang", "NewMatIntro", "InputCodeKeluar"]))
